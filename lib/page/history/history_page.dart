            ...
            return data.isNotEmpty
                ? ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      // Memastikan data yang diakses valid
                      var document = data[index];
                      var nama = document.get('nama');
                      var alamat = document.get('alamat');
                      var keterangan = document.get('keterangan');
                      var datetime = document.get('datetime');
                        ...
                        onTap: () {
                          AlertDialog dialogHapus = AlertDialog(
                            ...
                            actions: [
                              TextButton(
                                onPressed: () {
                                  dataCollection.doc(document.id).delete();
